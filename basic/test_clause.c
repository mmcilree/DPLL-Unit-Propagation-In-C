...
/***********************************************************************************
 * removeOutOfBounds: Checks that removing a literal with an out of bounds index   *
 *                    has no effect.                                               *
 ***********************************************************************************/
...
/************************************************************************************
 * checkSortLetters: Checks that a list of literals with single letter names are    *
 *                   correctly sorted.                                              *
 ************************************************************************************/
...
/************************************************************************************
 * checkSortNumbers: Checks that a list of literals with single digit names are     *
 *                   correctly sorted.                                              *
 ************************************************************************************/
...
/***********************************************************************************
 * checkSortLonger: Checks that literals with longer, randomised names are         *
 *                  correctly sorted.                                              *
 ***********************************************************************************/
